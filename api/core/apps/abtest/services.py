...
texts = [
    {'name': 'affiliate-menu',
     'text': 'Вы пригласили {ref_count} реф.\n\nВаша реф. ссылка:\n{link}',
     'text_ru': 'Вы пригласили {ref_count} рефералов. Нажмите кнопку чтобы поделиться.\n\nВаша реф. ссылка:\n{link}',
     'text_en': '',
     'version': 'a'},
    {'name': 'affiliate-menu',
     'text': 'Ты пригласил {ref_count} реф.\n\nВаша реф. ссылка:\n{link}',
     'text_ru': 'Ты пригласили {ref_count} рефералов.\n\nВаша реф. ссылка:\n{link}',
     'text_en': '',
     'version': 'b'},
    ...
    {'name': 'replenish_balance-bonus',
     'text': '🎁 За первое пополнение Вам начисляется бонус в размере {bonus} bonus leo.',
     'text_ru': ' 🎁 За первое пополнение Вам начисляется бонус в размере {bonus} bonus leo.',
     'text_en': '',
     'version': 'a'},
    {'name': 'replenish_balance-bonus',
     'text': '🎁 За первое пополнение тебе начисляется бонус в размере {bonus} bonus leo.',
     'text_ru': '🎁 За первое пополнение тебе начисляется бонус в размере {bonus} bonus leo.',
     'text_en': '',
     'version': 'b'},
    {'name': 'affiliate-bonus_for_referrer_from_deposit_referral',
     'text': '🎁 Ваш друг пополнил баланс и Вы получаете бонус в размере **{bonus}** bonus leo.',
     'text_ru': '🎁 Ваш друг пополнил баланс и Вы получаете бонус в размере **{bonus}** bonus leo.',
     'text_en': '',
     'version': 'a'},
    {'name': 'affiliate-bonus_for_referrer_from_deposit_referral',
     'text': '🎁 Твой друг пополнил баланс и ты получаешь бонус **{bonus}** bonus leo.',
     'text_ru': '🎁 Твой друг пополнил баланс и ты получаешь бонус **{bonus}** bonus leo.',
     'text_en': '',
     'version': 'b'},
    {'name': 'affiliate-new_referral',
     'text': 'По вашей реферальной ссылке пришёл друг.',
     'text_ru': 'По вашей реферальной ссылке пришёл друг.',
     'text_en': '',
     'version': 'a'},
    {'name': 'affiliate-new_referral',
     'text': 'По твоей реферальной ссылке пришёл друг.',
     'text_ru': 'По твоей реферальной ссылке пришёл друг.',
     'text_en': '',
     'version': 'b'},
