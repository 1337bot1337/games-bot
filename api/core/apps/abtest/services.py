...
texts = [
    ...
    {'name': 'affiliate-new_referral',
     'text': 'По Вашему приглашению зарегистрировался {friend_name}!\n\n'
             'Теперь за каждое пополнение от этого пользователя Вы будете получать Bonus Leo.',
    ...
    {'name': 'affiliate-new_referral',
     'text': '***{friend_name}*** зарегистрировался по твоему приглашению!\n\n'
             'Теперь за каждое пополнение от этого пользователя ты получишь Bonus Leo.',
    ...
    {'name': 'withdrawal-limit_error',
     'text': 'Вывод не доступен. Для вывода средств, необходимо сделать ставки минимум на {needsumbet} руб.',
     'text_ru': 'Вывод не доступен. Для вывода средств, необходимо сделать ставки минимум на {needsumbet} руб.',
     'text_en': None,
     'version': 'a'},
    {'name': 'withdrawal-limit_error',
     'text': 'Вывод не доступен. Для вывода средств, необходимо сделать ставки минимум на {needsumbet} руб.',
